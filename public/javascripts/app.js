(function(){
	var app = angular.module('jamstrands', [],
    ...
    app.factory('camera', ['$rootScope', '$window', function($rootScope, $window){
    	var camera = {};
    	camera.preview = $window.document.getElementById('senderVideo');
    	...
    	camera.start = function(){
			...
			.catch(Error('Failed to get access to user media.'));
		};
	...
	app.controller('ReceiverStreamsController', ['camera', '$location', '$http', function(camera, $location, $http){
		var rtc = this;
		rtc.remoteStreams = [];
	...
	app.controller('SenderStreamController',['camera', '$scope', '$window', function(camera, $scope, $window){
